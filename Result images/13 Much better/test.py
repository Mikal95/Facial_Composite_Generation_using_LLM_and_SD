...
guidance_scale = 20.0 # 15.0
num_inference_steps = 60 # 28, 50
size = "768×1152"
#size = 1024
for _ in range(20):
    ...
    file_name = "my_face_24_" + str(_) + "_" + str(size) + "_" + str(int(guidance_scale)) + "_" + str(num_inference_steps) + "_" + str(seed) + ".png"
