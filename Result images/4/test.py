...
prompt3_1 = ("a mugshot of a norwegian man. "
          "facing viewer. "
           ...
           "pale skin. "
           "diamond face shape. "
           "navy regulation cut hairstyle. "
           "dark blonde hair. "
           "straight hairline, big gap between the forehead and the hair. "
           "smooth forehead. "
           "flat ears. "
           "eyebrows are light brown, with soft angle. "
           "dark blue, almond, downturned, deepset, average sized eyes with heavily hooded eyelids. "
           ...
           "patchy 2 week chin strap beard. "
             )

clip_prompt = ("mugshot of a norwegian man. "
           "diamond face shape. "
           "dark blonde, navy regulation cut hairstyle. "
           "dark eyebrows with soft angle. "
           "dark blue, almond, downturned, deepset, average sized eyes with heavily hooded eyelids. "
           "full, chubby cheeks, "
           "very big, heart shaped lips with downturned corners. "
           "patchy 2 week chin strap beard. "
...
for _ in range(20):
    ...
    file_name = "my_face_14_" + str(_) + "_" + str(size) + "_" + str(int(guidance_scale)) + "_" + str(num_inference_steps) + "_" + str(seed) + ".png"
