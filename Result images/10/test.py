...
prompt3_1 = ("a mugshot of a norwegian man. "
          "facing viewer. "
           ...
           "pale skin. "
           "square face shape. "
           "short side swept quiff haircut. "
           "dark blonde hair. "
...
clip_prompt = ("mugshot of a norwegian man. "
           "square face shape. "
           "dark blonde short side swept quiff haircut. "
           "dark brown eyebrows with soft angle. "
...
for _ in range(20):
    ...
    file_name = "my_face_18_" + str(_) + "_" + str(size) + "_" + str(int(guidance_scale)) + "_" + str(num_inference_steps) + "_" + str(seed) + ".png"
