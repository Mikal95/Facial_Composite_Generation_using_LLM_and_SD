...
for _ in range(20):
    ...
    generator = torch.Generator(device="cuda").manual_seed(_)
    ...
    file_name = "restest_my_face_5_" + str(_) + "_" + str(size) + "_" + str(int(guidance_scale)) + "_" + str(num_inference_steps) + "_" + str(_) + ".png"
