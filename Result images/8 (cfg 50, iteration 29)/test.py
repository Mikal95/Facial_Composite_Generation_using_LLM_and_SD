...
prompt3_1 = ("a mugshot of a norwegian man. "
          "facing viewer. "
           ...
           "normal lighting. "
            "age late 20s. "
           "pale skin. "
           "diamond face shape. " # oblong face shape
...
clip_prompt = ("mugshot of a norwegian man. "
           "diamond face shape. "
           "dark blonde modern pompadour haircut. "
           "dark brown eyebrows with soft angle. "
...
for _ in range(20):
    ...
    file_name = "my_face_29_" + str(_) + "_" + str(size) + "_" + str(int(guidance_scale)) + "_" + str(num_inference_steps) + "_" + str(seed) + ".png"
    image.save(file_name)

# my_face_9_ uses portrait and SGL

# Good batches: 18, 21, 22, 23 (maybe), 24
# !!!!!!cfg 50 produces best results, adheres more to prompts and corrects artifacts!!!!!!!